// Generated on 2015-02-21 using generator-jekyllized 0.7.0
'use strict';
...
gulp.task('deploy', function () {
  ...
  $.shell.task('git config --global user.email "max@maksimize.com"')
  $.shell.task('git config --global user.name "Maksim Pecherskiy"')
